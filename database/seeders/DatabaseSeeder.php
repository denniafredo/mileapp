...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::collection('connote')->delete();
        DB::collection('connote')->insert(
            [
                "_id" => "f70670b1-c3ef-4caf-bc4f-eefa702092ed",
                "connote_number"=> 1,
                "connote_service"=> "ECO",
        ...
        DB::collection('koli')->delete();
        DB::collection('koli')->insert(
            [
            [
                "_id"=> "e2cb6d86-0bb9-409b-a1f0-389ed4f2df2d",
                "koli_length"=> 0,
            ...
            [
                "_id"=> "3600f10b-4144-4e58-a024-cc3178e7a709",
                "koli_length"=> 0,
            ...
            [
                "_id"=> "2937bdbf-315e-4c5e-b139-fd39a3dfd15f",
                "koli_length"=> 0,
        ...
        DB::collection('location')->delete();
        DB::collection('location')->insert(
            [
                "_id" => "5cecb20b6c49615b174c3e74",
        ...
        DB::collection('package')->delete();
        // DB::collection('package')->insert(
            // [
            //     "transaction_id"=> "d0090c40-539f-479a-8274-899b9970bddc",
